...
export default function About() {
    return (
        <div className='container'>
            ...
            <h3 className='texto1'>Página criada por: <a href = "https://github.com/1aufer" >Gabriel Antônio Laufer</a> e <a href="https://github.com/MatheusSosterSenac">Matheus Henrique Soster ("Software")</a> </h3>
        </div>
    )
}
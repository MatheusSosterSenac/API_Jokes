...
export default function Liberty() {
    ...
    return (
        <div className='container'>
            ...
            <h3>Página criada por: <a href="https://github.com/1aufer">Gabriel Antônio Laufer</a> e <a href='https://github.com/MatheusSosterSenac'>Matheus Henrique Soster ("Software") </a></h3>
